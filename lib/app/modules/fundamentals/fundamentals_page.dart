...
import 'package:goodwishes/app/modules/video/page/palestra_player_page.dart';
...
class FundamentalsPage extends StatefulWidget {
  @override
  _FundamentalsPageState createState() => _FundamentalsPageState();
}
...
class _FundamentalsPageState extends State<FundamentalsPage> {
          ...
          Expanded(
            child: Column(
              ...
              children: <Widget>[
                ...
                Text(
                  '${YoutubeService.instance.totalVideosPlayList} videos',
                  style: TextStyle(
                    color: Colors.grey[600],
                    fontSize: 16.0,
                    fontWeight: FontWeight.w600,
  ...
  Widget _buildVideo(Video video) {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => PalestraPlayerPage(id: video.id),
        ),
      ),
      child: Container(
  ...
  void _loadMoreVideos() async {
    ...
    var moreVideos = await YoutubeService.instance
        .fetchVideosFromPlaylist(playlistId: kPlayListIdPalestra);
