...
class _ProfilePageState extends State<ProfilePage> {
    ...
    await showDialog(
      ...
      builder: (BuildContext context){
        return AlertDialog(
          ...
          content: Text('Você realmente quer sair (logoff)?'),
          actions: <Widget>[
            TextButton(
              onPressed: () async {
                ...
                //clearAllData();
                await Modular.to.pushReplacementNamed('/login/sociallogin');
  ...
  Widget build(BuildContext context) {
      final ub = Modular.get<UserService>();
      //ub.getUserData();
