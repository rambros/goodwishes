...
class DraftMeditationDetailsPage extends StatefulWidget {
  final Meditation? meditation;
  const DraftMeditationDetailsPage({Key? key, this.meditation}) : super(key: key);

  @override
  _DraftMeditationDetailsPageState createState() => _DraftMeditationDetailsPageState();
}

class _DraftMeditationDetailsPageState
    extends ModularState<DraftMeditationDetailsPage, MeditationDetailsController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          title: const Text('Detalhes da Meditação em Edição'),
        ),
