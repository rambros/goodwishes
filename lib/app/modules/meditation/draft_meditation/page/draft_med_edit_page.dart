...
import '/app/modules/meditation/draft_meditation/controller/draft_med_edit_controller.dart';
import '/app/modules/meditation/guided/model/meditation.dart';
import '/app/shared/utils/ui_utils.dart';
import '/app/shared/widgets/get_image_url.dart';

class DraftMeditationEditPage extends StatefulWidget {
  final Meditation? meditation;
  const DraftMeditationEditPage({Key? key, this.meditation}) : super(key: key);

  @override
  _DraftMeditationEditPageState createState() => _DraftMeditationEditPageState();
}

class _DraftMeditationEditPageState
    extends ModularState<DraftMeditationEditPage, DraftMeditationEditController> {
                    ...
                    children: <Widget>[
                      FormBuilder(
                        ...
                        initialValue: {
                          ...
                          'authorText': widget.meditation?.authorText ?? '',
                          'authorMusic': widget.meditation?.authorMusic ?? '',
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            FormBuilderDropdown(
                              name: 'authorId',
                              decoration: InputDecoration(
                                  labelText: 'Autor do áudio',
                                  border: OutlineInputBorder(
                                    borderRadius: BorderRadius.circular(8.0),
                                  )),
                              hint: Text('Selecione o autor do áudio'),
                            ...
                            child: MaterialButton(
                              ...
                              onPressed: () {
                                ...
                                if (_fbKey.currentState!.validate()) {
                                  ...
                                  controller.editDraftMeditation(
                                      title: form['title'],
