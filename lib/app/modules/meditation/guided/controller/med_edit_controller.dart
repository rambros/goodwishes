...
part 'med_edit_controller.g.dart';

class MeditationEditController = _MeditationEditControllerBase with _$MeditationEditController;

abstract class _MeditationEditControllerBase with Store {
  ...
  Future editMeditation(
    ...
    result = await _meditationRepository.updateMeditation(_edittingMeditation, updateMap);
