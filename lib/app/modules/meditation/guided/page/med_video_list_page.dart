...
import 'med_video_player_page.dart';

class MeditationVideoListPage extends StatefulWidget {
  @override
  _MeditationVideoListPageState createState() => _MeditationVideoListPageState();
}
...
class _MeditationVideoListPageState extends State<MeditationVideoListPage> {
  ...
  Widget _buildVideo(Video video) {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => MeditationVideoPlayerPage(id: video.id),
        ),
      ),
      child: Container(
  ...
  void _loadMoreVideos() async {
    ...
    var moreVideos = await YoutubeService.instance
        .fetchVideosFromPlaylist(playlistId: kPlayListIdMeditation);
