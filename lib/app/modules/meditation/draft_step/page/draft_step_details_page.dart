...
import '/app/modules/meditation/draft_step/controller/draft_step_details_controller.dart';
                ...
                Observer(
                  builder: (BuildContext context) {
                    return Row(
                      ...
                      children: <Widget>[
                        Text('${widget.step!.audioDuration}',
                            style:
                                  ...
                                  child: IconButton(
                                      ...
                                      onPressed: () {
                                        ...
                                        var model = PlayerModel(
                                          ...
                                          urlAudio: widget.step!.audioUrl,
                                          title: widget.step!.title,
                                          duration: widget.step!.audioDuration,
                                        );
