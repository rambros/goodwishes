...
import 'congresso_player_page.dart';


class CongressoListPage extends StatefulWidget {
  @override
  _CongressoListPageState createState() => _CongressoListPageState();
}
...
class _CongressoListPageState extends State<CongressoListPage> {
  ...
  Widget _buildVideo(Video video) {
    return GestureDetector(
      onTap: () => Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => CongressoPlayerPage(id: video.id),
        ),
      ),
      child: Container(
  ...
  void _loadMoreVideos() async {
    ...
    var moreVideos = await YoutubeService.instance
        .fetchVideosFromPlaylist(playlistId: kPlayListIdCongresso);
