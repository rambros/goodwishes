...
class CongressoPlayerPage extends StatefulWidget {
  final String? id;

  CongressoPlayerPage({this.id});

  @override
  _CongressoPlayerPageState createState() => _CongressoPlayerPageState();
}

class _CongressoPlayerPageState extends State<CongressoPlayerPage> {
  ...
  Widget build(BuildContext context) {
    ...
    //       title: Text('Congresso de Raja Yoga'),
    //       actions: <Widget>[
