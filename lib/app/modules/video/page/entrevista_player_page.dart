...
class EntrevistaPlayerPage extends StatefulWidget {
  final String? id;

  EntrevistaPlayerPage({this.id});

  @override
  _EntrevistaPlayerPageState createState() => _EntrevistaPlayerPageState();
}

class _EntrevistaPlayerPageState extends State<EntrevistaPlayerPage> {
          ...
          children: <Widget>[
            ElevatedButton(
              style: ElevatedButton.styleFrom(
                ...
                onPrimary: Theme.of(context).accentColor, // foreground
              ),
