...
class StepDetailsPage extends StatefulWidget {
  ...
  const StepDetailsPage({Key? key, required this.args}) : super(key: key);
...
class _StepDetailsPageState
  ...
  @override
  void initState() {
    controller.init(widget.args.step!);
    super.initState();
  }
        ...
        children: [
          ...
          IconButton(
            ...
            onPressed: () {
              var model = PlayerModel(
                id: widget.args.step!.documentId,
                urlAudio: widget.args.step!.meditationAudioURL,
                title: widget.args.step!.title,
                duration: widget.args.step!.meditationDuration,
              );
              var playlist = controller.playlistStep;
              var args = ArgsPlayer( model: model, playlist: playlist);
              Modular.to.pushNamed(
...
class TitleField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(
      child: Text(widget.args.step!.title!,
...
class DescriptionField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: Center(
        child: Text(
          widget.args.step!.descriptionText!,
          textAlign: TextAlign.center,
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Stack(children: <Widget>[
        widget.args.step!.inspirationAudioURL != null
            ? Center(
                child: Opacity(
                  opacity: 0.7,
                  child: Container(
